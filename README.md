...
**This is a fork of [jpanther/lynx](https://github.com/jpanther/lynx) because the upstream project seems to be dead (see https://github.com/jpanther/lynx/pull/147 for example)**
...
🐛 [Bug reports & issues](https://github.com/domrim/lynx/issues)
💡 [Questions & feature requests](https://github.com/domrim/lynx/discussions)

![Screenshot](https://raw.githubusercontent.com/domrim/lynx/stable/images/screenshot.png)
...
2. Create `config/_default/module.toml` and add the following:
   ...
   ```toml
   [[imports]]
   path = "github.com/domrim/lynx"
   ```

3. Start your server using `hugo server` and the theme will be downloaded automatically.

4. In the root folder of your website, replace the `config.toml` file that was generated by Hugo with the one from Lynx. You will find the theme config file in the Hugo cache directory, or [download a copy](https://raw.githubusercontent.com/domrim/lynx/refs/heads/stable/config.toml) from GitHub.
...
links = {
   # Simple link
   { github = "https://github.com/domrim/lynx" }

   # Custom link
   { github = { href = "https://github.com/domrim/lynx", text = "GitHub Project" } }
}
```
...
- 🐛 **Bug reports & issues:** Use [GitHub Issues](https://github.com/domrim/lynx/issues)
- 💡 **Ideas for new features:** Open a discussion on [GitHub Discussions](https://github.com/domrim/lynx/discussions)
- 🙋‍♀️ **General questions:** Head to [GitHub Discussions](https://github.com/domrim/lynx/discussions)

If you're able to fix a bug or implement a new feature, I welcome PRs for this purpose. Learn more in the [contributing guidelines](https://github.com/domrim/lynx/blob/dev/CONTRIBUTING.md).
